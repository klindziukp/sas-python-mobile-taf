...
from test.test_main_page_another import MainPageTestAnother
...
main_page_test_another = unittest.TestLoader().loadTestsFromTestCase(MainPageTestAnother)
main_page_test_other = unittest.TestLoader().loadTestsFromTestCase(MainPageTestOther)

# Create a test suite combining all test classes
smoke_test = unittest.TestSuite([main_page_test, main_page_test_another, main_page_test_other])
